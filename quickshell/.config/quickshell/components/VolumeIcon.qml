...
Canvas {
    ...
    onPaint: {
        ...
        var speakerCs = muted ? "rgba(" + r + "," + g + "," + b + "," + (a * 0.3) + ")" : cs;
        ...
        ctx.beginPath();
        ctx.arc(xOffset + ax, cy, r1, -sweep, sweep);
        ctx.stroke();
        ctx.strokeStyle = waves >= 2 ? cs : dimCs;
        ctx.beginPath();
        ctx.arc(xOffset + ax, cy, r2, -sweep, sweep);
        ctx.stroke();
        ctx.strokeStyle = waves >= 3 ? cs : dimCs;
        ctx.beginPath();
        ctx.arc(xOffset + ax, cy, r3, -sweep, sweep);
        ctx.stroke();

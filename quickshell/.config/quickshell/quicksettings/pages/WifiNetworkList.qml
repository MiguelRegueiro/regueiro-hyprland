        ...
        Repeater {
            ...
            delegate: Rectangle {
                ...
                border.color: modelData.active
                    ? Qt.rgba(1, 1, 1, 0.14)
                    : (selectedForPrompt ? Theme.tileActiveBorder
                                        : (wifiHover.hovered ? Theme.qsCardBorderHover : Theme.qsCardBorder))

                MouseArea {
                    anchors.fill: parent
                    cursorShape: Qt.ArrowCursor
                    enabled: root.controller.forgetBusySsid === ""
                        && !wifiRow.forgetPending
                        && !wifiRow.forgetBusy
                        && !wifiRow.forgetHasResult
                    onClicked: {
                        root.controller.forgetConfirmSsid = ""
                        if (root.controller.connecting) return
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                color: {
                                    ...
                                    if (wifiRow.forgetPending) return Qt.rgba(1, 0.35, 0.35, 0.16)
                                    if (wifiRow.forgetBusy)    return Theme.qsCardChipBg
                                ...
                                Text {
                                    ...
                                    color: {
                                        ...
                                        if (wifiRow.forgetBusy)   return Theme.textDisabled
                                        if (wifiRow.forgetPending) return Theme.red

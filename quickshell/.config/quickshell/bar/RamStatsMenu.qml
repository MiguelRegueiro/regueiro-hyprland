...
PanelWindow {
    ...
    readonly property real surfaceHeight: Math.max(160, Math.min(root.height - root.menuY - 10, menuColumn.implicitHeight + root.attachTop + 14))
                            ...
                            GridLayout {
                                ...
                                Repeater {
                                    model: [
                                        {
                                            label: "Active",
                                            value: root.detailsService.formatGb(root.detailsService.ramActiveGb)
                                        },
                                        {
                                            label: "Wired",
                                            value: root.detailsService.formatGb(root.detailsService.ramWiredGb)
                                        },
                                        {
                                            label: "Inactive",
                                            value: root.detailsService.formatGb(root.detailsService.ramInactiveGb)
                                        },
                                        {
                                            label: "Free",
                                            value: root.detailsService.formatGb(root.detailsService.ramFreeGb)
                                        }
                                    ]
